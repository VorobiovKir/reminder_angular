var NoteController = function($http) {
    ...
    this.category = {
        id: '',
        url: that.server_url + '/categories/',
        data: {
            name: '',
        },
        helpText: {
    ...
    // $http.get(that.server_url + '/colors/').success(function(data) {that.colors = data;});
    // this.refreshPage();
